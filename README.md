...
GitHub 上の **任意のリポジトリ** にある HTML / Markdown を、スマホからリッチプレビューするための静的アプリです。バックエンドはなく、GitHub Pages だけで動きます。

公開 URL（Pages 有効化後）: https://debe-work.github.io/HtmlViewer/

## できること

- `owner/repo` や GitHub / Gist の blob/raw URL を貼って、このリポジトリ以外の HTML / Markdown も開く
- リポジトリをフォルダ単位でブラウズし、`.html` / `.md` をタップして描画。プレビューからソース表示に切り替え可能
- 相対パスの CSS / JS / 画像を解決してプレビュー（Markdown は GFM で描画し、相対画像・相対リンクも解決）
...
2. フォルダを辿り、HTML または Markdown ファイルを開く
...
- HTML: `https://github.com/Debe-work/HtmlViewer/blob/main/examples/index.html`
- Markdown: `https://github.com/Debe-work/HtmlViewer/blob/main/examples/README.md`
...
- 信頼できない HTML / Markdown 向けではありません（個人用）
